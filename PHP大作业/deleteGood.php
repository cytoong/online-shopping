...
if(!empty($_GET)) {
    ...
    if(isset($_GET["goodid"]))
    {
        ...
        if($result)
        {
            ...
            header("location:ManageGood.php?message=DeleteGoodSuccess!");
            return;
        }
        else{
            header("location:ManageGood.php?message=DeleteGoodFault!");
            return;
        }
    ...
    {
        header("location:ManageGood.php?message=NoInfo!");
        return;
    }
