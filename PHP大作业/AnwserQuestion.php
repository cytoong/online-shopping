            ...
            if($result1)
            {
                ...
                if($attr1[4]==$anwser)
                {
                    ...
                    <input type="text"value="<?php echo $name;?>" name="name" hidden>
                        <p>新密码: <input type="password" name="password" id="password"></p>
                        <p>重复新密码: <input type="password" name="repassword" id="repassword"></p>
...
<?php
                    ...
                    header("location:forgetPassword.php?message=WrongAnwser!");
                }
            }
        }
    }
